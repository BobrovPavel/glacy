...
var subscribeInput = document.querySelector("#input-email");
var subscribeLabel = document.querySelector("#input-email + label");
...
subscribeInput.addEventListener("focusout", function() {
    moveLabel(subscribeInput, subscribeLabel);
});
